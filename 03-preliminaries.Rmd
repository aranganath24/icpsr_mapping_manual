...
- The **bottom-right** window is the ***Files/Plots/Packages/Help/Viewer*** window. 
  - The "Files" tab displays all of the files that are within your working directory (we'll discuss the concept of a working directory below). 
...
After running that line of code, the "tmap" function will effectively be downloaded to your computer. Below, we can see how that line of code should look in your script, and how to run it:

```{r, echo=FALSE, results='asis', out.width='100%', fig.cap='The R Studio Interface'}
knitr::include_graphics('images/script.png')
```

Now, let's install the other packages we mentioned above, using the same procedure: 

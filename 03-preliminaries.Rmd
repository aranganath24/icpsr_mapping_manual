...
```{r, echo=FALSE, results='asis', out.width='100%', fig.cap='The R Studio Interface', fig.alt='R Studio Opened up On Desktop with Clean Interface Displayed'}
...
```{r, echo=FALSE, results='asis', out.width='100%', fig.cap='Installing tmap in R Script'}

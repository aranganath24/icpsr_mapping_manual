...
```{r, echo=FALSE, results='asis', out.width='100%', fig.cap='Setting Working Directory Via Menus', fig.alt='R Studio window open, with the Session menu selected and red boxes drawn around the Set Working Directory and Choose Directory buttons within the Session menu'    }

...
Now that you've installed and opened up R Studio, let's familiarize ourselves with the R Studio interface. When you open up R Studio, you'll see a window open that looks something like this:

...
```{r, fig.asp=0.5, echo=-1, message=FALSE}
tmap_mode("plot")
...
```{r, echo=FALSE, results='asis', out.width='100%', fig.cap='Map Exported as Image File', fig.alt='Screenshot of final covid_economic_map object as PNG image file that was exported from R Studio'}

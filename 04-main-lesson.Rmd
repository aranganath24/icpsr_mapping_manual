...
* Notice that the legend has a "Missing" category, to indicate countries for which we don't have data on the Covid-19 economic index. Instead of labelling it "Missing" let's label it as "No Data".
* Let's give the legend a title that describes the data: Mean of Covid Economic Intervention Index (1/1/2020 to 10/1/2020)"
* Finally, it's possible to experiment with different legend orientations. Let's flip the legend's orientation, turning it into a horizontal rather than vertical bar.

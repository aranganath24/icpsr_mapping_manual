...
* The ```tm_layout``` function also takes many arguments:
  ...
  * ```legend.position = c("left", "bottom")``` positions the legend at the bottom-left of the map
...
```{r, fig.asp=1, fig.dim=c(12, 12), message=FALSE, warning=FALSE}

...
Now, let's view the features of the edited "country_boundaries" dataset:

```{r, fig.asp=0.5}
worldmap
```

As expected, Antarctica has been deleted!

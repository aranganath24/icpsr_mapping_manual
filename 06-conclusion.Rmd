...
```{r, echo=FALSE, results='asis', out.width='100%', fig.cap='Map Based on Variable in ICPSR Dataset', fig.alt="Screenshot of map created and exported in tutorial; map is titled 'National Economic Support Measures in Response to the Covid-19 Pandemic'; the color scheme ranges from light green to represent low values, moving to darker shades of green as values for the variable increase; countries with no data are shaded grey; the legend, with values ranging from 0 to 0.72 is on the bottom-left of the map, and the map credits are printed on the bottom-right of the map below Australia and New Zealand"}

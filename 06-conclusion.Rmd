...
This illustrates an important point: when exploring ICPSR data, we're not limited to the materials provided by the author of a given dataset. We have the power to take this archived data, and represent it in novel ways that might further our understanding of topics that we're interested. In the most general terms, this tutorial was fundamentally about how to go about this process, and thereby help archived datasets come "alive." More specifically, we learned more about this process in practice by exploring how to put ICPSR data in geographic context by mapping the information in conventional tabular datasets. Every dataset has its idiosyncrasies, but the general workflow we developed here is quite portable; as Practice Exercise 3 demonstrated, the workflow and code we developed in the tutorial can, with a bit of tinkering, be adapted to other datasets as well.
